...
category: dev-tools
complexity: A
aliases: [ComponentDemoLayout]
dependencies: []
externalDependencies: ['react']
aiContext: |
  [One-sentence description of component purpose and key features.
  Focus on what AI should know to use this component correctly.]
---
...
✅ **DO use ComponentDemoLayout when:**
<!-- Add specific use cases here -->

❌ **DON'T use ComponentDemoLayout when:**
